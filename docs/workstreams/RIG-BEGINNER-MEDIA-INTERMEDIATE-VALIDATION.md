...
**Validation Baseline Before This Documentation Update:** `4351d7c6df53543bb2f2c632169ba7293687c119`  
...
- Retained Existing-Rig Tutorial Runtime — IN PROGRESS: Fixed Bobber passed; Basic Bottom, Jighead + Soft Plastic, Texas, and Wacky pending
...
**Status: REPLACEMENT SELECTION COMPLETE / RETAINED-TUTORIAL RUNTIME REGRESSION IN PROGRESS — 1 OF 5 PASSED**
...
- Validation documentation baseline immediately before this update: `4351d7c6df53543bb2f2c632169ba7293687c119`.
...
16. Continue retained tutorial playback regression: Basic Bottom, Jighead + Soft Plastic, Texas, and Wacky; then perform Inline Spinner D049 external-fallback check.
17. Beginner/Beginner+/Core and application regression pass.
18. Apply all five approved tutorial replacements together in one reviewed `data/rigs.js` correction package and correct the Bobber Stop alt-text defect in the same reviewed production-data correction phase.
19. Runtime-test every changed tutorial embed and re-test the affected Bobber Stop reference popover.
20. Reconcile the build-first tutorial-selection rule into governing documentation.
21. Documentation reconciliation/final closeout.
